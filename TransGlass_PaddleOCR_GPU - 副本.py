...
class OverlayWindow(QWidget):
    ...
    def _draw_translation_box(self, painter: QPainter, item: dict):
        ...
        # 背景色（区域平均色 + 15%透明度，可以看到原文）
        bg = item.get('bg_color', (240, 240, 240))
        bg_color = QColor(bg[0], bg[1], bg[2], 38)  # 15% of 255 ≈ 38
...
class HotkeySettingsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self._rows = {}
        for action_name in ["recognize", "switch_screen", "toggle_auto", "exit_app"]:
